...
#ISSUE- Powershell2.0 doesnt support INvoke-webrequest
#Solution - Download all requied installers in ubuntu host and share the folder to win7 & use older ps script to install them.
